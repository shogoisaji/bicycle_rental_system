...
class DetailPage extends StatefulWidget {
  int productId;
  DetailPage({super.key, required this.productId});
              ...
              child: Stack(
                children: [
                  SingleChildScrollView(
                      ...
                      child: FutureBuilder(
                          future: firebase
                              .fetchDocumentData('product${widget.productId}'),
                                          ...
                                          child: Stack(
                                            children: [
                                              ...
                                              Positioned(
                                                  ...
                                                  right: 20,
                                                  child: boldText(
                                                      '\$ ${data['pricePerHour'] * stateController.priceRate}',
                                                      Colors.black,
                                                      32)),
                                              Positioned(
                                                bottom: 0,
